...
namespace WebApplication1.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            ViewBag.UserType = new SelectList(db.Roles.Where(a => !a.Name.Contains("Deler")).ToList(), "Name", "Name");
        ...
        public ActionResult EditProfile()
        {
            ...
            var user = db.Users.Where(a => a.Id == UsreID).SingleOrDefault();
        ...
        public ActionResult EditProfile(EditProfileViewModel profile)
        {
            ...
            {
                ViewBag.Message = "كلمة سر الحالي غير مطابقة";
            }
            else
            {
                ...
                db.SaveChanges();
                ViewBag.Message = "تم التغير بنجاح ";
            }
